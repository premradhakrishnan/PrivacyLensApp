// components/sections/ProblemBackgroundSection.jsx
...
const ProblemBackgroundSection = () => {
  return (
    <Box>
      ...
      <Card elevation={3}>
        <CardContent sx={{ p: 4 }}>
          <Typography variant="h5" gutterBottom fontWeight="bold" color={brandColors.purple}>
          ...
          <Typography variant="h6" gutterBottom fontWeight="bold" color={brandColors.green} sx={{ mt: 4, mb: 2 }}>
          ...
          <Typography variant="h6" gutterBottom fontWeight="bold" color={brandColors.green} sx={{ mt: 4, mb: 2 }}>
            How Tracking Technology Collects Health Data
          </Typography>
          ...
          <Typography variant="h6" gutterBottom fontWeight="bold" color={brandColors.purple} sx={{ mt: 4, mb: 2 }}>
            Why PrivacyLens Is Needed
          </Typography>
...
export default ProblemBackgroundSection;